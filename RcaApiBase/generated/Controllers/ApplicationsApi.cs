...
namespace Quipu.RcaApiBase.OpenApi.Controllers
{
    ...
    public class ApplicationsApiController : ControllerBase
    {
        ...
        /// </summary>
        /// <remarks>Cancel the application  </remarks>
        /// <param name="caseId"></param>
        /// <response code="200">OK</response>
        /// <response code="500">Server Error</response>
        [HttpPost]
        [Route("/Quipu-GmbH/RCAApi/1.0.1/Application/{caseId}/cancel")]
        [ValidateModelState]
        [SwaggerOperation("ApplicationCaseIdCancelPost")]
        public virtual IActionResult ApplicationCaseIdCancelPost([FromRoute][Required] string caseId)
        {
        ...
        /// <response code="500">Server Error</response>
        [HttpGet]
        [Route("/Quipu-GmbH/RCAApi/1.0.1/Application/{id}")]
        [ValidateModelState]
        ...
        /// <response code="500">Server Error</response>
        [HttpPost]
        [Route("/Quipu-GmbH/RCAApi/1.0.1/Application")]
        [ValidateModelState]
        ...
        /// <response code="500">Server Error</response>
        [HttpPost]
        [Route("/Quipu-GmbH/RCAApi/1.0.1/Application/SaveDraft")]
        [ValidateModelState]
        ...
        /// <response code="500">Server Error</response>
        [HttpGet]
        [Route("/Quipu-GmbH/RCAApi/1.0.1/Applications/{clientRef}")]
        [ValidateModelState]
        [SwaggerOperation("ApplicationsClientRefGet")]
        [SwaggerResponse(statusCode: 200, type: typeof(List<ModelCase>), description: "List of Applications")]
        public virtual IActionResult ApplicationsClientRefGet([FromRoute][Required] string clientRef)
        {
